...
/* Album handling *
std::shared_ptr<Album> MetadataService::findAlbum(parser::Task& task, Artist* albumArtist) const {
...
/*
std::shared_ptr<Album> MetadataService::handleAlbum(parser::Task& task, std::shared_ptr<Artist> albumArtist, std::shared_ptr<Artist> trackArtist) const {
...
/**
 *  @brief MetadataService::handleArtists Returns Artist's involved on a track
 ...
 */
/*
std::pair<std::shared_ptr<Artist>, std::shared_ptr<Artist>> MetadataService::handleArtists(parser::Task& task) const {
...
/* Tracks handling */
/*
std::shared_ptr<AlbumTrack> MetadataService::handleTrack(std::shared_ptr<Album> album, parser::Task& task, std::shared_ptr<Artist> artist) const {
...
/* Misc */
/*
bool MetadataService::link(Media& media, std::shared_ptr<Album> album,
